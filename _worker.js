...
<head>
    ...
    <style>
        ...
        .container::before {
            ...
            width: 100%;
            height: 8px;
            background: linear-gradient(90deg, var(--soft-blue), var(--warm-purple));
        }
        ...
        .home-button:hover {
            ...
            box-shadow: 0 6px 20px rgba(107, 185, 240, 0.4);
        }
...
<body>
    <div class="bubbles">
        <div class="bubble" style="width: 72.34px; height: 72.34px; left: 15.67%; bottom: -72.34px; animation-duration: 18.45s; animation-delay: 2.34s;"></div>
        <div class="bubble" style="width: 89.12px; height: 89.12px; left: 42.89%; bottom: -89.12px; animation-duration: 14.23s; animation-delay: 0.78s;"></div>
        <div class="bubble" style="width: 65.78px; height: 65.78px; left: 78.23%; bottom: -65.78px; animation-duration: 16.89s; animation-delay: 3.12s;"></div>
        <div class="bubble" style="width: 94.56px; height: 94.56px; left: 5.34%; bottom: -94.56px; animation-duration: 12.67s; animation-delay: 1.89s;"></div>
        <div class="bubble" style="width: 81.23px; height: 81.23px; left: 63.45%; bottom: -81.23px; animation-duration: 19.23s; animation-delay: 0.45s;"></div>
        <div class="bubble" style="width: 102.34px; height: 102.34px; left: 29.78%; bottom: -102.34px; animation-duration: 15.67s; animation-delay: 4.23s;"></div>
        <div class="bubble" style="width: 68.9px; height: 68.9px; left: 87.12%; bottom: -68.9px; animation-duration: 17.89s; animation-delay: 2.67s;"></div>
        <div class="bubble" style="width: 76.45px; height: 76.45px; left: 51.23%; bottom: -76.45px; animation-duration: 13.45s; animation-delay: 1.23s;"></div>
        <div class="bubble" style="width: 83.67px; height: 83.67px; left: 22.89%; bottom: -83.67px; animation-duration: 16.78s; animation-delay: 3.89s;"></div>
        <div class="bubble" style="width: 97.23px; height: 97.23px; left: 74.56%; bottom: -97.23px; animation-duration: 14.56s; animation-delay: 0.67s;"></div>
        <div class="bubble" style="width: 71.89px; height: 71.89px; left: 38.67%; bottom: -71.89px; animation-duration: 18.23s; animation-delay: 2.12s;"></div>
        <div class="bubble" style="width: 88.34px; height: 88.34px; left: 9.78%; bottom: -88.34px; animation-duration: 15.23s; animation-delay: 4.56s;"></div>
        <div class="bubble" style="width: 79.12px; height: 79.12px; left: 56.89%; bottom: -79.12px; animation-duration: 17.34s; animation-delay: 1.78s;"></div>
        <div class="bubble" style="width: 93.45px; height: 93.45px; left: 83.23%; bottom: -93.45px; animation-duration: 13.89s; animation-delay: 3.34s;"></div>
        <div class="bubble" style="width: 85.67px; height: 85.67px; left: 45.34%; bottom: -85.67px; animation-duration: 19.67s; animation-delay: 0.89s;"></div>
    </div>
